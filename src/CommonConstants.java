...
public class CommonConstants {
    public static final String DATA_PATH = "assets/data.txt";
    public static final String IMAGE_PATH = "assets/1.png";
    public static final String FONT_PATH = "assets/Cartoonero.ttf";
