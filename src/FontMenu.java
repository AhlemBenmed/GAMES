...
public class FontMenu extends JDialog {
    ...
    private void addFontColorChooser(){
        ...
        currentColorBox.setBorder(BorderFactory.createLineBorder(Color.decode("#000814")));
        add(currentColorBox);
        ...
        chooseColorButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Color c = JColorChooser.showDialog(FontMenu.this, "Select a color", Color.decode("#000814"));
